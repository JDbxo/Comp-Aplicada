...
# Entrada - Solicitar números al usuario
#x = 100.35
#y = 20.34
...
print(f"Suma            : {x:>6} + {y:<6} = {x + y:>10.2f}")# Signo > despues de los dos puntos es alinearlo a la derecha al numero en este caso alinearlo a 6  
print(f"Resta           : {x:>6} - {y:<6} = {x - y:>10.2f}")# Signo < despues de los dos puntos es alinearlo a la izquierdaal numero en este caso alinearlo a 6 
