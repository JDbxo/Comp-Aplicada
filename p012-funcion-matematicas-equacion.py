...
#fx_y_star = 3 * mt.pow(x,2) + mt.sqrt( mt.pow(x,2) + mt.pow(y,2)) + mt.pow(mt.e, mt.log(x))
fx_y_star = 3 * x**2 + mt.sqrt(x**2 + y**2) + mt.exp(mt.log(x)) #Lo mismo de arriba pero simplificado con **
