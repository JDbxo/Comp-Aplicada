...
# Programa para generar una lista de numeros impares y buscar elementos.
...
if buscar in impares:
    ...
    print(f"Resultado: El elemento {buscar} esta en la lista en la posición (indice) {indice}.")
else:
